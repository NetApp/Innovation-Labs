...
![openshift administration settings with filtered search to console](/openshift-administration-settings.png)
...
![openshift-console-plugins-list](/openshift-console-plugins-list.png)

Click on ```Disabled``` to open the ```Console plugin Enablement``` window and change it to ```Enable``` then ```Save```.   
![openshift-console-plugin-enablement](/openshift-console-plugin-enablement.png)

After a couple of minutes, a notification should invite you to refresh the console, click on ```Refresh web console```.   
![openshift-console-plugin-refresh](/openshift-console-plugin-refresh.png)
...
![openshift-console-plugin-refreshed](/openshift-console-plugin-refreshed.png)
