...
Pull the chart from the `fix-scc` branch:
...
```bash
# Run from Innovation-Labs/charts/netapp-neo on branch fix-scc
...
Optional: confirm the checked-out branch before deploying.
